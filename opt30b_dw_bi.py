...
gpu_0_mem, gpu_1_mem = "23GiB", "38GiB"
...
# if (len(device_ids) == 4):
#     max_mem = {0: "22GiB", 1: "44GiB", 2: "44GiB", 3: "44GiB", "cpu": "150GiB"}
# elif (len(device_ids) == 3):
#     max_mem = {0: "22GiB", 1: "44GiB", 2: "44GiB", "cpu": "150GiB"}
# elif (len(device_ids) == 2):
#     max_mem = {0: "22GiB", 1: "44GiB", "cpu": "150GiB"}
# else:
#     max_mem = {0: "22GiB", "cpu": "150GiB"}

if (len(device_ids) == 4):
    max_mem = {0: gpu_0_mem, 1: gpu_1_mem, 2: gpu_1_mem, 3: gpu_1_mem, "cpu": "150GiB"}
elif (len(device_ids) == 3):
    max_mem = {0: gpu_0_mem, 1: gpu_1_mem, 2: gpu_1_mem, "cpu": "150GiB"}
elif (len(device_ids) == 2):
    max_mem = {0: gpu_0_mem, 1: gpu_1_mem, "cpu": "150GiB"}
else:
    max_mem = {0: gpu_0_mem, "cpu": "150GiB"}
...
load_checkpoint_in_model(
    ...
    weights_path, 
    device_map=device_map, 
    offload_folder=my_config.off_loader_path, 
    dtype='float16', 
    offload_state_dict=False
)
model.tie_weights()
